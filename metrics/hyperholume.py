...
if __name__ == "__main__":
    ...
    arr = list()
    referencePoint = [100,100,100,100,100] #F4:5,5,5  POL: 20,30  mF4: 12,12,12 others: 2,2,2
                            #WFG-3D 3,5,7   WFG-2D 3,5
                            #DTLZ5-6 2,2,2 DTLZ7 1,1,6 VNT3 9,17,1
    hv = HyperVolume(referencePoint)
    max = 0
    pos = 1
##    for i in range(1,31):
##       data = parse_data('D:\\experiments\\Revision\\WFG1_4_10_3\\MPBI\\'+str(i))
##       front = data
...
##       #print "%.4E"%volume,
##    arr.sort()
##    #print str(arr[0])+' '+ str(arr[15])+' '+arr[29]
##    print "%.4E"%arr[len(arr)-1]
##    print "%.4E"%arr[len(arr)/2]
##    print "%.4E"%arr[0]
##    print pos

    data = parse_data('D:/experiments/Revision/igdend_MP2')
    front = data
    volume = hv.compute(front)
    print (volume)
            
    # data = parse_data('D:\\experiments\\ccc\\moeadp_F5.txt');
    # front = data
    # volume = hv.compute(front)
    # print volume
